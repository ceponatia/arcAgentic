 ...
 */
export function formatScent(scent) {
    const parts = [];
 ...
 */
export function formatTexture(texture) {
    const parts = [texture.primary];
 ...
 */
export function formatVisual(visual) {
    const parts = [visual.description];
 ...
 */
export function formatFlavor(flavor) {
    const parts = [];
    // Add intensity prefix if not default
 ...
 */
export function formatBodyMap(bodyMap) {
    const lines = [];
